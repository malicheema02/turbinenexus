...
export const metadata: Metadata = {
  title: "Contacts — Turbine Nexus Admin",
};
            ...
            {contacts.map((c) => (
              <tr key={c.id} className="hover:bg-[#F8FAFC] transition-colors">
                ...
                <td className="px-4 py-3">
                  <a
                    href={`mailto:${c.email}`}
                    className="flex items-center gap-1.5 text-slate-600 hover:text-[#1B3A5C] transition-colors"
                  >
                ...
                <td className="px-4 py-3">
                  {c.company ? (
                    <Link
                      href={`/admin/companies/${c.company.id}`}
                      className="text-[#1B3A5C] hover:underline text-xs"
                    >
                      {c.company.name}
                    </Link>
                  ) : (
